...
export const deliveryGuides = withDeliveryOverrides(INSTALL_DELIVERY, {
  ...
  "설치 서비스 안내": { rows: { "설치 소요시간": "약 90~120분", "주의사항": "설치 장소까지의 운반 경로(계단·복도·문틈) 확인이 필요합니다. 전동 기능 연결을 위해 콘센트 위치를 미리 확인해 주세요. 엘리베이터 미설치 건물은 사전 고객센터 문의를 요청드립니다." } },
});

export const notices = createNotices("install", "품명: 전동 침대 프레임 / 소재: LPM(E0 등급 친환경 보드), 스틸, 전동 리클라이닝 모터 / 제조국: 대한민국 / KC 전기용품 안전인증 완료 / A/S 책임자: 한샘 고객센터(1688-4945)");
