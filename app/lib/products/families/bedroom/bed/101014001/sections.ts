...
export const deliveryGuides = withDeliveryOverrides(INSTALL_DELIVERY, {
  ...
  "설치 서비스 안내": { rows: { "설치 소요시간": "약 60~90분", "주의사항": "설치 장소까지의 운반 경로(계단·복도·문틈) 확인이 필요합니다. 엘리베이터 미설치 건물은 사전 고객센터 문의를 요청드립니다." } },
});

export const notices = createNotices("install", "품명: 패밀리침대 프레임 / 소재: LPM(E0 등급 친환경 보드), 원목 다리 / 제조국: 대한민국 / KC 인증 완료 / A/S 책임자: 한샘 고객센터(1688-4945)");
