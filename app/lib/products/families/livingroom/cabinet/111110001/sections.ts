  ...
  return [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "image", src: `/images/products/${FAMILY_PATH}/${FAMILY_CODE}-function-02.webp`, alt: "클린트 어반 거실장 기능 설명" },
      ],
    },
    {
      id: "size",
    ...
    },
    {
      ...
      label: "주의사항",
      blocks: [
        { type: "image", src: `/images/products/${FAMILY_PATH}/${FAMILY_CODE}-warranty-01.webp`, alt: "클린트 어반 거실장 주의사항" },
      ],
    },
  ];
}
