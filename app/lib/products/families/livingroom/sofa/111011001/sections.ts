...
export const deliveryGuides = withDeliveryOverrides(INSTALL_DELIVERY, {
  "설치 서비스 안내": { rows: { "설치 소요시간": "약 40~70분", "주의사항": "리클라이너 제품 특성상 설치 경로 폭 확인이 필요합니다. 엘리베이터 미설치 건물은 사전 고객센터 문의를 요청드립니다." } },
  "반품 / 교환 안내": { rows: { "A/S": "한샘 고객센터 1688-4945 / 제품 하자 발생 시 2년 내 무상 A/S" } },
});

export const notices = createNotices("install", "품명: 리클라이너 소파 / 소재: 천연가죽, 스틸 리클라이닝 모듈, 목재 프레임 / 제조국: 대한민국 / KC 인증 완료 / A/S 책임자: 한샘 고객센터(1688-4945)");
