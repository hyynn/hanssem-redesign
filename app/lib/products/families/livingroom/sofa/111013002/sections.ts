...
export const deliveryGuides = withDeliveryOverrides(PARCEL_DELIVERY, {
  "배송 안내": { rows: { "배송방법": "택배 배송", "배송기간": "결제 후 2~3일 이내 (영업일 기준)", "배송비": "무료", "배송지역": "전국 배송 (단, 제주도 및 도서산간 지역 추가 배송비 발생)" } },
  "반품 / 교환 안내": { rows: { "반품 불가 조건": "상품 사용·훼손·오염된 경우 / 포장 훼손으로 상품 가치 감소된 경우", "A/S": "한샘 고객센터 1688-4945 / 제품 하자 발생 시 1년 내 무상 A/S" } },
});

export const notices = createNotices("parcel", "품명: 좌식 리클라이너 / 소재: 패브릭(폴리에스터), 스틸 회전·접이식 프레임 / 제조국: 대한민국 / KC 인증 완료 / A/S 책임자: 한샘 고객센터(1688-4945)");
